        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="font-bold text-2xl md:text-3xl text-gray-900 tracking-tight flex items-center gap-2">
                    {{ __('Tambah Rombongan Belajar') }}
                </h2>
                <p class="text-sm md:text-base text-gray-500 mt-1 font-medium">Buat kelas baru dan tentukan guru sebagai wali kelasnya.</p>
            </div>
        </div>
    </x-slot>
            ...
            <div class="p-6 sm:p-8 border-b border-gray-100 bg-gray-50/50">
                <div class="flex items-center gap-4 mb-2">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500">Form pembuatan nama kelas dan penugasan wali kelas.</p>
                    </div>
                </div>
            </div>

            <form action="{{ route('classes.store') }}" method="POST" class="p-6 sm:p-8">
                @csrf
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <div class="relative group">
                            ...
                            <input type="text" name="nama_kelas" id="nama_kelas" value="{{ old('nama_kelas') }}" required autofocus
                                ...
                                placeholder="Contoh: A1 (Abu Bakar)">
                        </div>
                ...
                <div class="mt-10 pt-6 border-t border-gray-100 flex items-center justify-end gap-3">
                    ...
                    <button type="submit" class="px-6 py-3 bg-sage hover:bg-emerald-800 text-white font-semibold rounded-xl transition-all shadow-md shadow-sage/20 hover:-translate-y-0.5 flex items-center">
                        <i data-lucide="save" class="w-5 h-5 mr-2"></i> Simpan Kelas
                    </button>
                </div>
            </form>
        </div>
